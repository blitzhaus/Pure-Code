...
public class GenerateNormalGraphForDeConvo extends JInternalFrame {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2261479894665860341L;
	ApplicationInfo appInfo;
	ProcessingInputsInfo procInputInst;

	GenerateNormalGraphForDeConvo(double[] xPlot, double[] yPlot, double[] termX,
		...
		DeConvolutionVariables.createDeConvoVarInstance().workSheetOutputInst.getPlotOutputs().getLinearPlots().add(
				chart);
