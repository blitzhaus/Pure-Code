...
public class WagNelsonDeConvolution {

	static WagNelsonDeConvolution wagNelsonDeConvoInst = null;

	public static WagNelsonDeConvolution createWagNelsonDeConvoInstance() {
		if (wagNelsonDeConvoInst == null) {
			wagNelsonDeConvoInst = new WagNelsonDeConvolution();
		}
		return wagNelsonDeConvoInst;
	}
	...
	public void calculateWagNelsonDeConvolution(ApplicationInfo applicationInfo)
		...
		deConvoVarInst.analysisType = "wagnelson";
	...
	private void estimateFractionAbsorption() {
		CalculateWagNelsonFracAbsorption polyExpoFracAbsCalInst = new CalculateWagNelsonFracAbsorption();
