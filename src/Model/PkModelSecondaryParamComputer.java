...
public class PkModelSecondaryParamComputer {
	...
	static PkModelSecondaryParamComputer pkModelSecondaryParamCal = null;

	public static PkModelSecondaryParamComputer createPkSecParamCalInstance() {
		if (pkModelSecondaryParamCal == null) {
			pkModelSecondaryParamCal = new PkModelSecondaryParamComputer();
		}
		return pkModelSecondaryParamCal;
	}

	ClearanceSecondaryParamComputer clearanceModelSecParamCalInst;
	
	public void secondaryParamCalForPKModel(double[] param, int modelNumber,
		...
		if (clearancaParam == true) {
			clearanceModelSecParamCalInst = new ClearanceSecondaryParamComputer();
			clearanceModelSecParamCalInst.secondaryParamCalForClearanceParam(dose, modelNumber,
