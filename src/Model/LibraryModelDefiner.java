...
public class LibraryModelDefiner {
	...
	PkLibModelDefiner pkModelInst;
	PdLibModelDefiner pdModelInst;
	MmLibModelDefiner mmModelInst;
	IrmLibModelDefiner irmModelInst;
	PkPdLinkLibModelDefiner pkpdLinkModelInst;
	DissolutionModelDefiner dissolutionModelInst;
	...
	public double chooseLibraryModel(double[] par, double[] infusionTime,
		...
		if (pkPdInst.analysisType.equals("pk")) {
			pkModelInst = new PkLibModelDefiner();
			
			value = pkModelInst.choosePkModel(par, infusionTime, conDose, conDosingTime, x,
					fn_no, Extra_DATA, rowIdx, row);
		} else if (pkPdInst.analysisType.equals("pd")) {

			 pdModelInst = new PdLibModelDefiner();
			value = pdModelInst.choosePdModel(par, infusionTime, conDose,
					conDosingTime, x, fn_no, Extra_DATA, rowIdx, row);

		} else if (pkPdInst.analysisType.equals("mm")) {
			 mmModelInst = new MmLibModelDefiner();
			value = mmModelInst.chooseMmModel(par, infusionTime, conDose,
					conDosingTime, x, fn_no, Extra_DATA, rowIdx, row);
		} else if (pkPdInst.analysisType.equals("irm")) {
			irmModelInst = new IrmLibModelDefiner();
			value = irmModelInst.chooseIrmModel(par, infusionTime, conDose,
					conDosingTime, x, fn_no, Extra_DATA, rowIdx, row);

		} else if (pkPdInst.analysisType.equals("pkpdlink")) {

			pkpdLinkModelInst = new PkPdLinkLibModelDefiner();
			value = pkpdLinkModelInst.choosePkPdModel(par, infusionTime, conDose,
					conDosingTime, x, fn_no, Extra_DATA, rowIdx, row);

		}else if (pkPdInst.analysisType.equals("invitro")) {

			dissolutionModelInst = new DissolutionModelDefiner();
			value = dissolutionModelInst.evaluateModelFunction(par, x);
	...
	public double choosePkModel(double[] par, double[] infusionTime,
		...
		if (algebraicModel == true) {
			...
			if (clearanceParam == false) {
				...
				ClearanceLibModelDefiner inst = new ClearanceLibModelDefiner();
				value = inst.chooseAlgebraicModel(par, infusionTime, conDose,
						conDosingTime, x, fn_no, Extra_DATA, rowIdx, row);
			}
		...
		{
			DeLibModelDefiner dE = new DeLibModelDefiner();
			value = dE.chooseLibraryModel(par, infusionTime, conDose,
					conDosingTime, x, fn_no, Extra_DATA, rowIdx, row);
		}
