...
public class GenerateLinGraphForDeConvoFracAbs extends
		JInternalFrame {
	
	DeConvolutionVariables deConvoVarInst;
	ProcessingInputsInfo procInputInst;

	public GenerateLinGraphForDeConvoFracAbs(double[] xPlot,
		...
		deConvoVarInst.getWorkSheetOutputInst().getPlotOutputs().getLinearPlotForXVsWeightedResidualY().add(chart);
