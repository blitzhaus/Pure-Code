...
public class GenerateLogGraphForDeConvoCumuAbs extends
		JInternalFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1772749622513642420L;
	DeConvolutionVariables deConvoVarInst;
	ProcessingInputsInfo procInputInst;
	
	public GenerateLogGraphForDeConvoCumuAbs(final String title,
		...
		final JFreeChart chart = ChartFactory.createXYLineChart(profile,
				"Observed"
						...
						+ timeUnit + ")", "Cumu_Abs", dataset, PlotOrientation.VERTICAL, true, true,
				false);
		...
		deConvoVarInst.getWorkSheetOutputInst().getPlotOutputs().getLogPlotForObsevedYVsWeightedPredictedY().add(chart);
