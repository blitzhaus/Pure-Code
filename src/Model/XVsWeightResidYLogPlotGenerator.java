...
public class XVsWeightResidYLogPlotGenerator extends JInternalFrame {

	PkPdInfo pkPdInst;
	public XVsWeightResidYLogPlotGenerator(final String title,
		...
		pkPdInst.getWorkSheetOutputInst().getPlotOutputs().getLogPlotForXVsWeightedResidualY().add(chart);
