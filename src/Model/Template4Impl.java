...
public class Template4Impl {
	...
	public Template4Impl(TableWizardCoordinator tempImpl) {
	...
	public void prepareTemplate4ForGrpCvCombn(String grpVariable,
		...
		// printMatrix("Template-4..", sortedData, sortedData.length,
		// sortedData[0].length);
	...
	public static void main(String[] args) {
		...
		Template4Impl ti4 = new Template4Impl(ti);
		...
		ti4.setTabWizIpOptions(groupVariables, idVariables, crossVariables,
		...
		TableWizardOpMetricOptions opMetListing = new TableWizardOpMetricOptions(
				hTableOpOptions);
		ti4.setTabWizOpOptions(opMetListing);
		ti4.prepareTemplate();
	}
