...
public class PlasmaSparsePOAllHaveTauParamCal {
	...
	void calculateParameters(int j) throws RowsExceededException,
		...
		concRelateParamCal(j);
		sparseRelateParamCal(j);
		calculateAucAndAumc();
		...
		if (appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
			...
			setLambdaZRealatedParamToMissing();
			...
			int clast_PredIndex =  ncaInst.lastNonZero(appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
					...
					.get(
							appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
									appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getSelectedWorkBookIndex())
									.getSelectedSheetIndex()).getNcaInfo()
					.getProcessingInputs().getLambdazDataobj().getLambdaZDetailsOf(j).getPredictedConc());
			ncaInst.Clast_pred = appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
					...
					.get(
							appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
									appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getSelectedWorkBookIndex())
									.getSelectedSheetIndex()).getNcaInfo()
					.getProcessingInputs().getLambdazDataobj().getLambdaZDetailsOf(j).getPredictedConc()[clast_PredIndex];
		...
		if (ncaInst.noPtsLambdaZ == 0) {
			setLambdaZAndAucRelateParamToMissing();

		} else {

			calculateLambdaZAndAucRelatedParam(j);
	...
	private void calculateLambdaZAndAucRelatedParam(int j) {
	...
	private void setLambdaZAndAucRelateParamToMissing() {
	...
	private void setLambdaZRealatedParamToMissing() {
	...
	private void sparseRelateParamCal(int j) {
		if (appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
				appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getSelectedWorkBookIndex()).getWorkSheetObjectsAL()
				.get(
						appInfo.getProjectInfoAL().get(appInfo.getSelectedProjectIndex()).getWorkBooksArrayList().get(
	...
	private void concRelateParamCal(int j) {
		ncaInst.Cmax = ncaInst.maxVal(ncaInst.Y);
		ncaInst.Cmax_D = ncaInst.Cmax / ncaInst.Dose[j];
