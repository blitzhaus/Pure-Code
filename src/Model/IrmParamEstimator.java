...
public class IrmParamEstimator {

	static IrmParamEstimator irmParamCalInst = null;

	public static IrmParamEstimator createIrmParamCalInstance() {
		if (irmParamCalInst == null) {
			irmParamCalInst = new IrmParamEstimator();
		}
		return irmParamCalInst;
	}
	...
	public void calculateIrmParameters(ApplicationInfo appInfo)
