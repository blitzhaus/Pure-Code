...
public class PlasmaPOSerialNoTauParamCal {
	...
	void calculateParameters(int j) throws RowsExceededException,
		...
		if (ncaInst.ifCalculateParam == false) {
			storeMissingeParamValueInResultStructure(j);
	...
	private void storeMissingeParamValueInResultStructure(int j) {
	...
	private void calculateLambdaZRelatedParam(int j) {
		...
		ncaInst.lambdaZStr = ncaInst.round(ncaInst.lambdaZ, ncaInst.roundTo)
				+ "";
		ncaInst.RsqStr = ncaInst.round(ncaInst.Rsq, ncaInst.roundTo) + "";
		ncaInst.adjRsqStr = ncaInst.round(ncaInst.adjRsq, ncaInst.roundTo) + "";
		...
		ncaInst.lambdaZUpperStr = ncaInst.round(ncaInst.lambdaZUpper
				* ncaInst.unitConvertAmount[0], ncaInst.roundTo)
				+ "";
		ncaInst.CorrTermXYStr = ncaInst.round(ncaInst.CorrTermXY,
				ncaInst.roundTo)
				+ "";
