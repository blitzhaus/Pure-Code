...
public class AsciiInitialParamValue {

	PkPdInfo pkpdInst;
	ListOfDataStructures dataStructInst;
	ProcessingInputsInfo procInputInst;

	void initParamValueInfo(int numberOfSortVariable, int ii)
	...
	void getDefaultParamBoundary() {
		...
		for (int parCount = 0; parCount < noOfParam; parCount++) {
			...
			pkpdInst.initSimplex[parCount][parCount] = -1;
			pkpdInst.lowerBound[parCount] = -1;
			pkpdInst.upperBound[parCount] = -1;
