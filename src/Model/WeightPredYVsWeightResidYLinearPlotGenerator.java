...
public class WeightPredYVsWeightResidYLinearPlotGenerator extends
		JInternalFrame {
	PkPdInfo pkPdInst;
	
	public WeightPredYVsWeightResidYLinearPlotGenerator(
		...
		pkPdInst.getWorkSheetOutputInst().getPlotOutputs().getLinearPlotForWeightedPredictedYVsWeightedResidualY().add(chart);
