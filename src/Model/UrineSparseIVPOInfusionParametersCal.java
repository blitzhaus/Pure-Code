...
public class UrineSparseIVPOInfusionParametersCal {
	...
	void calculateParameters(int j) throws RowsExceededException,
		...
		if (ncaInst.ifCalculateParam == false) {
			...
			calculateAurcLambdaZRelatedParam(j);
	...
	private void copyConcAndVolume(int j) {
						...
						appInfo
								...
								.get(
										appInfo
												...
												.getSelectedWorkBookIndex())
								.getSelectedSheetIndex()).getNcaInfo()
				.getProcessingInputs().getProfileInfoObj().getSubject_obs()[j]];
						...
						appInfo
								...
								.get(
										appInfo
												...
												.getSelectedWorkBookIndex())
								.getSelectedSheetIndex()).getNcaInfo()
				.getProcessingInputs().getProfileInfoObj().getSubject_obs()[j]; ii++) {
									...
									appInfo
											...
											.get(
													appInfo
															...
															.getSelectedWorkBookIndex())
											.getSelectedSheetIndex())
							.getNcaInfo().getProcessingInputs().getNcaDat()[ncaInst.sum1
							- appInfo
									.getProjectInfoAL()
									.get(appInfo.getSelectedProjectIndex())
									.getWorkBooksArrayList()
