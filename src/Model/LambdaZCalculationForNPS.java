...
public class LambdaZCalculationForNPS {

	public LambdaZCalculationForNPS() {
	...
	private void calculateLambdaZUsingRange(double[] time, double[] conc,
		...
		npsInst.Intercept = Intercept;
		npsInst.lambdaZ = lambdaZ;
		...
		if (NoOfNonZeroPoints >= 3) {
			...
			if (LambdaZCalculationMethod == 1) {
...

				{
					...
					npsInst.lambdaZ = lambdaZValue[maxAdjRsqIndex];
					npsInst.Intercept = InterceptValue[maxAdjRsqIndex];
				}
