...
public class WorkSheetOutputs implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1151061419218765362L;
	//For NCA
	...
	private String[] ttTransformedColumn;
	

	public String[] getTtTransformedColumn() {
		return ttTransformedColumn;
	}

	public void setTtTransformedColumn(String[] ttTransformedColumn) {
		this.ttTransformedColumn = ttTransformedColumn;
	}
	...
	Template12Results[] template6Results;
	
	public Template12Results[] getTemplate6Results() {
	...
	public boolean equals(Object obj) {
		...
		if (parameterValuesAL == null) {
			if (other.parameterValuesAL != null)
				return false;
		} else if (!Arrays.deepEquals(convert(parameterValuesAL),(convert(other.parameterValuesAL))))
			return false;
/*		if (plotOutputs == null) {
	...
	public void setParameterValuesAL(ArrayList<String> parameterValuesAL) {
		this.parameterValuesAL = parameterValuesAL;
	}
	...
	public WorkSheetOutputs(){
		...
		ttTransformedColumn = new String[1];
