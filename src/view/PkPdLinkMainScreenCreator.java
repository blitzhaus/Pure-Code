...
public class PkPdLinkMainScreenCreator {
	...
	public static PkPdLinkMainScreenCreator PKPDLINK_MAIN_SCREEN = null;
	public static PkPdLinkMainScreenCreator createPkPdLinkMainScreenInstance() throws RowsExceededException, WriteException, BiffException, IOException{
		if(PKPDLINK_MAIN_SCREEN == null){
			PKPDLINK_MAIN_SCREEN = new PkPdLinkMainScreenCreator();
		}
		return PKPDLINK_MAIN_SCREEN;
	}


	JInternalFrame pkpdLinkMainInternalFrame;
	...
	PkPdLinkMainScreenGUICreator pkpdLinkMainGuiCreatorInst;
	CaMappingDispGuiCreator caMapDispGuiCreatorInst;
	
	
	public void PkPdLinkMainScreenCreation() throws RowsExceededException, WriteException, IOException, BiffException {
		...
		DDViewLayer.createMTInstance().mainTabbedFrame.setSize(DDViewLayer
			...
			pkpdLinkMainInternalFrame = new JInternalFrame("PD Main Screen", false,
					false, false, false);
			/* ncaMainInternalFrame. */
			JinternalFrameFunctions.createIFFunctionsInstance().removeTitleBarForinternalFrame(pkpdLinkMainInternalFrame);
			pkpdLinkMainInternalFrame.setLocation(0, 0);
			pkpdLinkMainInternalFrame
	...
	//	}
		...
		pkpdLinkMainGuiCreatorInst = PkPdLinkMainScreenGUICreator.createPkPdLinkMainScreenGui();
		//pkpdLinkMainGuiCreatorInst.createPkPdLinkMainScreenGui();
		...
		pkpdLinkMainInternalFrame.setVisible(true);
		pkpdLinkMainInternalFrame.setBorder(DDViewLayer.createViewLayerInstance().b);
		DDViewLayer.createMTInstance().mainTabbedDesktopPane.add(pkpdLinkMainInternalFrame);
		pkpdLinkMainInternalFrame.moveToFront();
	}
