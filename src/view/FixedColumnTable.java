...
public class FixedColumnTable implements ChangeListener, PropertyChangeListener
{
	...
	public static FixedColumnTable FIXED_COLUMN_TAB_INST = null;
	public static FixedColumnTable createFixedColumnTableInst(){
		if(FIXED_COLUMN_TAB_INST == null){
			FIXED_COLUMN_TAB_INST = new FixedColumnTable();
		}
		return FIXED_COLUMN_TAB_INST;
	}
	 ...
	 */
	public void FixedColumnTable(int fixedColumns, JScrollPane scrollPane)
	{
