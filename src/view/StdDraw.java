...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // default pen radius
    private static final double DEFAULT_PEN_RADIUS = 0.0035;
    ...
    private static void init() {/*
       ...
       // frame = new JFrame();
		 internalFrame = new JInternalFrame("ppp",true,true,true,true);
		MainLayoutPage.removeTitleBarForinternalFrame(internalFrame);
        ...
        internalFrame.setContentPane(draw);
        internalFrame.addKeyListener(std);    // JLabel cannot get keyboard focus
      
        internalFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);            // closes all windows
        // frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);      // closes only current window
        internalFrame.setTitle("Standard Draw");
        internalFrame.setJMenuBar(createMenuBar());
        internalFrame.pack();
        internalFrame.requestFocusInWindow();
        internalFrame.setVisible(true);
        if(NCAoutputPlots.isFromNcaOutoutPlots == true){
        	NCAMainScreen.displayResultsinternalFrameDesktopPane.add(internalFrame);
        	NCAMainScreen.outputPlotsArraylist.add(internalFrame);
        }
        else{
        	PlotMavenMainScreen.plotMavenResultsDisplayDesktopPane.add(internalFrame);
        }
    ...
    *************************************************************************/
    ...
    public static void save(String filename) {
        ...
        }/*else  if (suffix.toLowerCase().equals("wmf")) {
            try { ImageIO.write(offscreenImage, suffix, file);
            System.out.println("Yes saved as wmf image");
            	}
            catch (IOException e) { e.printStackTrace();
            	System.out.println("could not save as bmp image");
            }
        }*/

        else {
        	String errorTitle = "Error";
        	String errorMessage = "Invalid File Format:"+"  Please choose from JPEG/JPG/GIF/PNG";
        	String[] errors = new String[2];
        	errors[0] = errorTitle;
        	errors[1] = errorMessage;
        	JFrame f = null;
        	AboutDialog.main(errors);
    ...
    public void actionPerformed(ActionEvent e) {
   	JFrame f = new JFrame();
        FileDialog chooser = new FileDialog(f, "Export Image as GIF/JPEG/JPG/PNG", FileDialog.SAVE);
    ...
    /*
    	JFileChooser exportImage = new JFileChooser();
    	exportImage.showSaveDialog(null);
    	exportImage.setVisible(true);
    	String selectedFile = exportImage.getFile();
    	//String fileName = selectedFile.getName();
    	if(selectedFile != null){
    		StdDraw.save(selectedFile);
    	}*/
    }
