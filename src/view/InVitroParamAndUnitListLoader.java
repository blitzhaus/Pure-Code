...
public class InVitroParamAndUnitListLoader {
	...
	static InVitroParamAndUnitListLoader paramListInst = null;

	public static InVitroParamAndUnitListLoader createParamListInstance() {
		if (paramListInst == null) {
			paramListInst = new InVitroParamAndUnitListLoader();
		}
	...
	public InVitroParamAndUnitListLoader() {
