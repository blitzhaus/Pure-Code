...
public class CopyingTableValueforEditMenu {

	public static CopyingTableValueforEditMenu CopyingTableValue = null;

	public static CopyingTableValueforEditMenu createCopyingTableValueInstance() {
		if (CopyingTableValue == null) {
			CopyingTableValue = new CopyingTableValueforEditMenu();
		}
		return CopyingTableValue;
	}

	void CopyingTableValueForEdit() throws RowsExceededException,
		...
		if ((DDViewLayer.createViewLayerInstance().isNCAExecution == false)
			...
			if (DDViewLayer.createFeaturesPanelInstance().PreviewLable
					.isVisible() == true) {
				performCopyingFromImportDataTable();
			}
		...
		if ((DDViewLayer.createViewLayerInstance().isNCAExecution == true)
			...
			// performCopyingFromDisplayDataTable();
	...
	private void performCopyingFromImportDataTable() {
	...
	private void performCopyingFromDisplayDataTable()
	...
	private void performCopyingFromCATable() throws RowsExceededException,
			WriteException, BiffException, IOException {
		JTable tab = new JTable();
		...
		else if (CaInitEstimateDispGuiCreator.createCaInitEstGui().tableForInitialParameterValueForCA
	...
	private void performCopyingFromNCATable() throws RowsExceededException,
			WriteException, BiffException, IOException {
		JTable tab = new JTable();
