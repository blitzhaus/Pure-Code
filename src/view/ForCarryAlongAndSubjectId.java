...
public class ForCarryAlongAndSubjectId {
	...
	public static ForCarryAlongAndSubjectId CarryAlong_AND_SUBID = null;

	public static ForCarryAlongAndSubjectId createCarryAlongAndSubIdInst() {
		if (CarryAlong_AND_SUBID == null) {
			CarryAlong_AND_SUBID = new ForCarryAlongAndSubjectId();
		}
		return CarryAlong_AND_SUBID;
	}

	public ForCarryAlongAndSubjectId() {
	...
	public void prepareCarryAlongData(String[][] sortedData,
			String[][] unSortedData) {
