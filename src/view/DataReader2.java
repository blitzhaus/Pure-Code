...
public class DataReader2{
       ...
       public String Extension = "";
 	   ...
 	   /** Constructor-1 (File name provided through console) (file type - .txt, .csv, .dat, .dta, , .bat, .prn)  */
//***********************************************************************************************************************
        ...
        while(isFileExists == false){
         ...
         try {
			...
			while (line != null){
               ...
               StringTokenizer stringToken = new StringTokenizer (line, delims);
      ...
      //*******************************************************
           ...
           new_fileArray = new double [new_rowCount][new_colCount];  //****** Array set
           StringFileArray = new String [rowCount][colCount];  //****** Array set
           new_StringFileArray = new String [new_rowCount][new_colCount];  //****** Array set
...
Blue:
			    ...
			    {
			    	StringTokenizer stringToken1 = new StringTokenizer (lineRead, delims);
					while (stringToken1.hasMoreTokens()){
						String s1 = stringToken1.nextToken();
						ssStart = s1.startsWith("#");
						if(ssStart == false)
						{
							if((s1 == "--") || (s1.startsWith("--") == true) || (s1.contains("--") == true))
							{
							...
							{
								if(dataType.equals("double"))
									fileArray [rcount][ccount] = Double.parseDouble(s1);
								if(dataType.equals("String"))
            ...
            StringTokenizer stringToken2 = new StringTokenizer(lineRead, delims);
            ...
            while (stringToken2.hasMoreTokens()){
                   ...
                   String ss = stringToken2.nextToken();
					ssStart = ss.startsWith("#");
			 		if(ssStart == false)
			 		{
						 new_fileArray [new_rcount][new_ccount] = Double.parseDouble(ss);
      ...
      //*******************************************************
        ...
        {
            System.out.println (" The Number of Rows or Colums are more than declared in a array ");
          //  System.exit(0);
...
//**************************************************************************************************************
 	   ...
 	   /** Constructor-2 (File name provided through argument) (file type - .txt, .csv, .dat, .dta, , .bat, .prn)  */
//***********************************************************************************************************************
